...
# plot and save
plot(lines_national)
# ggsave(paste(output_dir_plots, "figure1B.tiff", sep=""))
...
# ggsave(paste(output_dir_plots, "figure1A.tiff", sep=""),
...
# ggsave(paste(output_dir_plots, "figure1C.tiff", sep=""), 
...
ggsave(paste(output_dir_plots, "figure_1.tiff", sep=""), 
       plot=figure_1,
       dpi = 150,
       width = 8,
       height = 10,
...
# plot and save
plot(bars_IMD_med)
# ggsave(paste(output_dir_plots, "figure_2B.tiff", sep=""))
...
# plot and save
plot(ribplot)
# ggsave(paste(output_dir_plots, "figure_2A.tiff", sep=""), ribplot)
...
ggsave(paste(output_dir_plots, "figure_2.tiff", sep=""), 
       plot=figure_2,
       dpi = 150,
       width = 10,
       height = 8,
...
# plot and save
plot(ribplot_meas)
# ggsave(paste(output_dir_plots, "figure_3A.tiff", sep=""), ribplot_meas)
...
# ggsave(paste(output_dir_plots, "figure_3B.tiff", sep=""),
#        measlines_prepost)
```
...
ggsave(paste(output_dir_plots, "figure_3.tiff", sep=""), 
       plot=figure_3,
       dpi = 150,
       width = 10,
       height = 10,
...
ggsave(paste(output_dir_plots, "figure_4.tiff", sep=""), 
       plot=figure_env,
       dpi = 150,
       width = 6,
       height = 6,
