...
# 2.1 get codes for measures from OpenPrescribing.net
source("./00.1_get_OP_codes.R", echo=FALSE) # Calls OpenPrescribing.net for BNF codes, leaves OP_codes variable in workspace
...
WARNING: this section could take ~18 hours to run.
```{r}
# Start time
